...
function() {
    ...
    function qt() {
        ...
        if ("string" == typeof a) qt(t, Rr[a], n, i, o, s);
            ...
            function(e, r) {
                ...
                o.push(c),
                qt(r, t.type === r.type ? l: Rr[r.type], n, i, o, s)
            })
    ...
    Bn = function(t) {
        function e() {
            ...
            return o = n = Le(this, t.call(this, i, o)),
            o.changing_ = !1,
            r = o,
            Le(n, r)
        }
    ...
    Lr.prototype.featuresVolumeControl = !0,
    Lr.prototype.featuresFullscreenResize = !1,
    Lr.prototype.featuresPlaybackRate = !1,
    Lr.prototype.featuresProgressEvents = !1,
    Lr.prototype.featuresTimeupdateEvents = !1,
    Lr.prototype.featuresNativeTextTracks = !1,
    Lr.withSourceHandlers = function(t) {
    ...
    bn.registerComponent("Tech", Lr),
    Lr.registerTech("Tech", Lr),
    Lr.defaultTechOrder_ = [];
    var Rr = {},
    Br = {
        buffered: 1,
        currentTime: 1,
    ...
    var qr = function(t) {
        function e() {
            return Ie(this, e),
            Le(this, t.apply(this, arguments))
        }
        return De(e, t),
        e.prototype.createEl = function() {
            return t.prototype.createEl.call(this, "div", {
    ...
    so = function(t) {
        ...
        e.prototype.loadTech_ = function(t, e) {
            ...
            "Html5" !== i && this.tag && (Lr.getTech("Html5").disposeMediaElement(this.tag), this.tag.player = null, this.tag = null),
            this.techName_ = i,
            this.isReady_ = !1;
            var s = {
                source: e,
    ...
    Zt.registerComponent = function(t, e) {
        Lr.isTech(e) && ze.warn("The " + t + " tech was registered as a component. It should instead be registered using videojs.registerTech(name, tech)"),
        bn.registerComponent.call(bn, t, e)
    },
    Zt.getTech = Lr.getTech,
    Zt.registerTech = Lr.registerTech,
    Zt.use = Vt,
    Zt.browser = Oe,
    Zt.TOUCH_ENABLED = Pe,
    Zt.extend = mo,
...
function() { !
    ...
    function(a, b, c, d, e, f, g) {
        b && !1 !== b.HELP_IMPROVE_VIDEOJS && (e.random() > .01 || (f = b.location, g = b.videojs || {},
